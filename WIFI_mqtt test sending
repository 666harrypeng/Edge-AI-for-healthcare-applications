...
const char* ssid = "MSI 8198";
const char* password = "7269y5H!";
const char* mqtt_server = "emqx.broker.io";
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  int bottleCount = int(topic); // assume no bottles unless we correctly parse a value from the topic
