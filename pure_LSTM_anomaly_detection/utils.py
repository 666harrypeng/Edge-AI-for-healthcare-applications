...
def process_config(json_file):
    ...
    save_name = f"{config['exp_name']}-{config['dataset']}-win_len{config['l_win']}-look_back{config['look_back_num']}-future_seq{config['l_seq']}-LSTMunits{config['num_hidden_units_lstm']}-LSTMlayers{config['num_layers']}"
