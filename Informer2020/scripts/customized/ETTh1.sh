...
# tested
python -u main_informer.py --model informer --data ETTh1 --root_path ./data/ETT --data_path ETTh1.csv --inverse --features M --seq_len 96 --label_len 48 --pred_len 24 --e_layers 2 --d_layers 1 --attn prob --des 'Exp' --itr 2
python -u main_informer.py --model informer --data ETTh1 --root_path ./data/ETT --data_path ETTh1.csv --inverse --features M --seq_len 48 --label_len 48 --pred_len 24 --e_layers 2 --d_layers 1 --attn prob --des 'Exp' --itr 2

'''

# TODO

# python -u main_informer.py --model informer --data ETTh1 --root_path ./data/ETT --data_path ETTh1.csv --inverse --features M --seq_len 168 --label_len 168 --pred_len 168 --e_layers 2 --d_layers 1 --attn prob --des 'Exp' --itr 2

# python -u main_informer.py --model informer --data ETTh1 --root_path ./data/ETT --data_path ETTh1.csv --inverse --features M --seq_len 168 --label_len 168 --pred_len 336 --e_layers 2 --d_layers 1 --attn prob --des 'Exp' --itr 2

# python -u main_informer.py --model informer --data ETTh1 --root_path ./data/ETT --data_path ETTh1.csv --inverse --features M --seq_len 336 --label_len 336 --pred_len 720 --e_layers 2 --d_layers 1 --attn prob --des 'Exp' --itr 2
