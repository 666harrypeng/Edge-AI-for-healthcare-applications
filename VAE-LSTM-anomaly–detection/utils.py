...
def get_args():
    ...
    parser.add_argument('-c', '--config', required=True, default='vae_lstm_config.json', help='Path to the configuration JSON file')
...
def process_config(json_file):
    ...
    save_name = f"{config['exp_name']}-{config['dataset']}-win_len{config['l_win']}-look_back{config['look_back_num']}-codesize{config['code_size']}-VAEunits{config['num_hidden_units_vae']}-LSTMunits{config['num_hidden_units_lstm']}"
