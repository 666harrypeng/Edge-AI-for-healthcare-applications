...
class VAEmodel(nn.Module):
    def __init__(self, config):
        ...
        self.config = config
        self.l_win = config['l_win']    # time window size
        self.input_size = config['input_size']    # input size (sensor types)
        self.code_size = config['code_size']    # size of the latent space
